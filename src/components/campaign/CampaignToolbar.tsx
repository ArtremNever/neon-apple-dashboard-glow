...
const blockTypes = [
  ...
  { type: 'application' as const, label: 'APP', icon: Smartphone, color: 'from-purple-500 to-purple-600' },
  { type: 'platform' as const, label: 'SOURCE', icon: Globe, color: 'from-cyan-500 to-cyan-600' },
  { type: 'campaign' as const, label: 'CAMPAIGN', icon: Megaphone, color: 'from-red-500 to-red-600' },
  { type: 'adset' as const, label: 'ADSET', icon: Users, color: 'from-orange-500 to-orange-600' },
  { type: 'creative' as const, label: 'CREATIVE', icon: Palette, color: 'from-green-500 to-green-600' },
];
...
export const CampaignToolbar = ({
  ...
  return (
    <div className="h-16 bg-slate-900/95 backdrop-blur-sm border-b border-green-500/20 flex items-center justify-between px-6 shadow-lg">
      {/* Block Type Buttons */}
      ...
      <div className="flex items-center gap-3">
        {/* Zoom Controls */}
        <div className="flex items-center gap-1 bg-slate-800/60 rounded-lg p-1 border border-green-500/20">
          <Button
            variant="ghost"
            size="sm"
          ...
          <div className="px-3 py-1 text-xs font-medium text-green-400 min-w-12 text-center">
            {zoom}%
          </div>
        ...
        <Separator orientation="vertical" className="h-6 bg-green-500/20" />
        ...
        <Button
          ...
          className={`
            ...
            ${isValid 
              ? 'bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-400 hover:to-emerald-400 text-white shadow-lg shadow-green-500/20 hover:shadow-green-500/30 hover:scale-105' 
